...
export default function Proveedores() {
  ...
  const handleResultClick = (proveedor) => {
    setFormData({
      id: proveedor.id,
        ...
        return (
          <div className="w-full">
            <div className="mb-6 text-center">
              ...
              <p className="text-gray-600">MODIFIQUE LOS DATOS DEL PROVEEDOR</p>
            </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      <Head>
        <title>VERTIMAR | Proveedores</title>
        <meta name="description" content="Gestión de proveedores VERTIMAR" />
      </Head>
      ...
      <div className="flex flex-col md:flex-row w-full max-w-6xl bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="w-full md:w-1/3 bg-blue-800 p-8 flex flex-col items-center justify-center">
          <h1 className="text-2xl font-bold text-blue-300 mb-2">PROVEEDORES</h1>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="max-h-60 overflow-y-auto mb-4">
              {searchResults.length > 0 ? (
                searchResults.map((proveedor, index) => (
                  <div 
                    key={index} 
                    className="p-2 border-b hover:bg-gray-100 cursor-pointer"
                    onClick={() => handleResultClick(proveedor)}
                  >
                    {proveedor.nombre}
                  </div>
                ))
